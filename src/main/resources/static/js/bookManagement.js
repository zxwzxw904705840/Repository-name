    ...
    dataTableHot = $("#table_list").bootstrapTable({
        ...
        columns: [
            ...
            },
            {
                ...
                title: "发表状态",
                field: "bookPublishStatus"
            }, {
                title: "著作状态",
                field: "statusOpt",
                formatter: function (value, row, index) {
                    var operateHtml;
                    if(row.bookStatus == "NORMAL"){
                        operateHtml = '<span> 正常</span>';
                    }else if(row.bookStatus == "REVIEWING"){
                        operateHtml = '<span class=" btn_blue" onclick="agreeModal(\'' + row.bookId + '\')"> 升级审核</span>';
