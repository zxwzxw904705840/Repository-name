            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function (value, row, index) {
                        ...
                        var operateHtml = '<button  class="btn btn_blue"   onclick="editModal(\'' + row.projectCode + ',' +
                            row.projectName + ',' + row.userName + ',' + row.projectLevel + ',' + row.projectEstablishDate + ',' + row.projectProgress + ',' + row.projectFund
                            + '\')"> 编辑</button>';
                        return operateHtml;
                    }
                }]
